...
int main(int argc, char* argv[]) {
    ...
    // Selezione manuale dei PDF tramite Esplora risorse
    vector<fs::path> pdf_files = open_file_dialog();
    ...
    if (pdf_files.empty()) {
        cout << "Nessun file PDF selezionato.\n";
        out  << "Nessun file PDF selezionato.\n";
        system("pause");
    }
